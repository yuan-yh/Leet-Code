...
| 3 | **Course Schedule (Topological Sort)** — Variants, log-file input variants | LC 207, 210 | 5 |
| 4 | **LRU / LFU Cache** | LC 146, 460 | 4 |
...
| 8 | **Two Sum / Duplicate Numbers** — Variants with multiple answers, follow-ups | LC 1, variants | 3 |
| 9 | **Merge Sorted Arrays / Lists** — Merge two sorted arrays, merge k sorted lists | LC 88, 23 | 3 |
| 10 | **Log Parsing / Processing** — Parse logs, find common entries across logs, brute force | LC 560 variant, custom | 3 |
...
| 14 | **Rate Limiter + Cycle Detection** | LC 141, 142 | 2 |
...
| 46 | Rotten Oranges (BFS) | LC 994 | 1 |
